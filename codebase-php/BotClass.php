...
class Bot {
    ...
    var $PremiumMax;	  //addded by phreaker 27-02-2011
...
//        $this->ld->UpdateInventory($bod->_value['data'][0]['data']['userInfo']['player']['inventory'] , $EmptyFirst);
        ...
        $this->PremiumMax = $bod->_value['data'][0]['data']['userInfo']['player']['commodities']['storage']['premium_goods']; //addded by phreaker 27-02-2011
...
// ==============================================================================
	...
	// ==============================================================================
	//== Function for Factory Plugin by Phreaker
	//== Function to Harvest Factory
	// ==============================================================================
    function harvestFactory($obj) {
        $this->SendMsg('Harvest ' . $obj['itemName'] . ' '. $obj['contractName'] . " x=" . $obj['position']['x'] . " y=" . $obj['position']['y'] . " id:" .$obj["id"]);
        ...
        $result = $serializer->serialize($amf);
        $x = $this->SendRequest($result);
        $this->Add2Report('Harvest Factory');
    }
// ==============================================================================
...
// ============================================================================== $silent = true  if($silent)
	...
	$amf->_bodys[0]->_value[1][0]['params'][2][0] = "premium_goods";
...
// ============================================================================== $silent = true  if($silent)
    function supplyBBB($obj, $silent = true) {
        if($silent)$this->SendMsg('Supply ' . $obj['itemName'] . " x=" . $obj['position']['x'] . " y=" . $obj['position']['y']);
...
// ==============================================================================
   ...
   // ==============================================================================
	...
	// ==============================================================================
	//== Function for Factory Plugin by Phreaker
	//== Function to Start Contract
	// ==============================================================================
    function startFactoryContract($obj, $sname) {
        $this->SendMsg('Sending ' . $sname . " x=" . $obj['position']['x'] . " y=" . $obj['position']['y']);
        ...
        $result = $serializer->serialize($amf);
        $x = $this->SendRequest($result);
        $this->Add2Report('Start Contract');
    }
   // ==============================================================================
...
//  =========================================================
	...
	// ==============================================================================
    function collectRentx($obj) {
        $this->SendMsg('Collect rent from house success');
	...
	// ==============================================================================
    function seedPlot($obj) {
        $this->SendMsg('seed peas success');
        ...
        $amf->_bodys[0]->_value[1][0]['params'][1] = $obj;
		$amf->_bodys[0]->_value[1][0]['params'][1]['itemName'] = plot_crop;
		$amf->_bodys[0]->_value[1][0]['params'][1]['contractName'] = plot_peas;
        $amf->_bodys[0]->_value[1][0]['params'][2] = null;
        $amf->_bodys[0]->_value[1][0]['params'][2][0] = '';
