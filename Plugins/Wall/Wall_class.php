...
if($server['click'] == "setting" )
 {
    ...
    echo 'Click <a href="/Plugins/Wall/Main.php?action=menu&click=cleanDB&cleantime=36">HERE 36</a> to clean request older than 36 hours.<br>';
    echo 'Click <a href="/Plugins/Wall/Main.php?action=menu&click=cleanDB&cleantime=24">HERE 24</a> to clean request older than 24 hours.<br>';
    echo 'Click <a href="/Plugins/Wall/Main.php?action=menu&click=cleanDB&cleantime=12">HERE 12</a> to clean request older than 12 hours.<br>';
    echo 'Click <a href="/Plugins/Wall/Main.php?action=menu&click=cleanDB&cleantime=6">HERE 6</a> to clean request older than 6 hours.<br>';
    echo 'Click <a href="/Plugins/Wall/Main.php?action=menu&click=cleanDB&cleantime=4">HERE 4</a> to clean request older than 4 hours.<br>';
    echo 'Click <a href="/Plugins/Wall/Main.php?action=menu&click=cleanDB&cleantime=2">HERE 2</a> to clean request older than 2 hours.<br>';
    echo 'Click <a href="/Plugins/Wall/Main.php?action=menu&click=cleanDB&cleantime=0">HERE ALL</a> to clean ALL request.<br>';
    echo '<br>';
    echo '<br>';
    echo '<br>';
    echo '<br>';
...
if($server['click'] == "" || $server['click'] == "home")
 {
    echo '<br>Welcome the Wall Plugin. <br>';
    echo '<br>';
    echo 'Via this plugin you can generate requests, like you would post them on the facebook wall.<br>';
    echo 'These requests will <b>not be published</b> on the facebook wall<br>';
    echo 'A file will be generated, this file you can open in a web browser and click the links.<br>';
    echo '<br>';
    echo 'Note that you can NOT send items to yourself, so send the file to you friends to click.<br>';
    ...
    echo '&nbsp;&nbsp; a file contains requests for the last 48 hours. (that is how long a request is valid, after 48 hours the request will be expired.<br>';
    echo 'Step 5: Open the file with a browser (you need to be logged in to facebook). See instruction in that file.<br>';
    echo '&nbsp;&nbsp;<br>';
    echo '&nbsp;&nbsp;<br>';
    echo '<br>';
    echo '<br>';
...
if($server['click'] == "youget")
 {
    ...
    foreach ($res as $item)
     {    
          ...
          if($item['name'] == "request_signature") { echo '<td><input DISABLED type="checkbox" id="'.$item['name'].'" '.$checked.'></td>';}
		  else {  echo '<td><input type="checkbox" id="'.$item['name'].'" '.$checked.'></td>';}
		  ...
		  if($item['name'] == "request_signature") {echo "<td>Do Not Use this</td>";}
		  echo '<td>'.$notUse.'</td>';
          echo '</tr>';
     }
...
if($server['click'] == "othergetxp")
 {
    $WallSet[$server['click']] = (array)$this->ld->GetPlSettings('Wall_'.$server['click']);
    echo '<br>';
    echo 'On this page select the Wall request that will give XP to the <b>person</b> who click the links.<br>';
    echo '<br><form >';
    echo '<table class="table2">';
    echo '<tr><th>Generate?</th><th>Request name</th><th>Wait time (hours)</th><th>You get</th><th>Helper get</th><th>Max. helpers</th><tr>';
...
if($server['click'] == "othergetcoin")
 {
    $WallSet[$server['click']] = (array)$this->ld->GetPlSettings('Wall_'.$server['click']);
    echo '<br>';
    echo 'On this page select the Wall request that will give Coins to the <b>person</b> who click the links..<br>';
    echo '<br><form >';
    echo '<table class="table2">';
    echo '<tr><th>Generate?</th><th>Request name</th><th>Wait time (hours)</th><th>You get</th><th>Helper get</th><th>Max. helpers</th><tr>';
...
if($server['click'] == "othergetgood")
 {
    $WallSet[$server['click']] = (array)$this->ld->GetPlSettings('Wall_'.$server['click']);
    echo '<br>';
    echo 'On this page select the Wall request that will give Goods  to the <b>person</b> who click the links.<br>';
    echo '<br><form >';
    echo '<table class="table2">';
    echo '<tr><th>Generate?</th><th>Request name</th><th>Wait time (hours)</th><th>You get</th><th>Helper get</th><th>Max. helpers</th><tr>';
...
if($server['click'] == "othergetitem")
 {
    $WallSet[$server['click']] = (array)$this->ld->GetPlSettings('Wall_'.$server['click']);
    echo '<br>';
    echo 'On this page select the Wall request that will give Items to the <b>person</b> who click the links.<br>';
    echo '<br><form >';
    echo '<table class="table2">';
    echo '<tr><th>Generate?</th><th>Request name</th><th>Wait time (hours)</th><th>You get</th><th>Helper get</th><th>Max. helpers</th><tr>';
...
if($server['click'] == "youget" || $server['click'] == "othergetxp"|| $server['click'] == "othergetcoin"|| $server['click'] == "othergetgood"|| $server['click'] == "othergetitem")
 {
    ...
    echo '<tr><td>Wait time (hours)</td><td>You can make this request every xx hours.</td></tr>';
    ...
    echo '<tr><td>Max. helpers     </td><td>How many helpers can click/use the request.</td></tr>';
    echo '</table>';
    echo '<hr>';
 }
// =====================================================================================================
