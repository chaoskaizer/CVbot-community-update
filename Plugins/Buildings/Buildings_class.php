...
//                    req["shipMissionIN"]=$("#shipMissionIN  :selected").text();
		      req["shipMissionIN"]=$("#shipMissionIN").val();
...
echo '                  <hr>
                        <input type="checkbox" id="supplybb">Supply business buildings with goods? <b>Select THIS</b><br>
						<input type="checkbox" id="supplybbb">Supply business buildings without goods? <b>or THIS, DO NOT select both.</b><br>
