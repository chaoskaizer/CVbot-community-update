    ...
    <body>
        <form >
                ...
                <div style="margin-left: 20px">
                    <input id="AcceptN" type="checkbox" value="0" size="4">Accept work from neighbors.<br><hr>
                    <table id="maint" border="0">
                       ...
                       <tr id="down">
                        <td  colspan="2">
                          <table>You have &nbsp;<span id="ncount"></span>&nbsp; neighbors, you can do &nbsp;<span id="act_count"></span>&nbsp; actions, please set how much actions should be done for every type, you can also set which item should be used for every action type.
                          <tr BGCOLOR="grey"><td><b>Construction Site</b></td><td> If selected this will be done first.</td></tr>
                          <tr><td>Help Construction Site</td><td><input id="constr" type="text" value="0" size="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item:&nbsp;<select id="constrIN">'.$this->GetOptionsByClassName("ConstructionSite").'</select>Reputation &  Coins</td></tr>

                          <tr BGCOLOR="grey"><td><b>Crops</b></td><td>If selected this will be done 2nd.</td></tr>
                          <tr><td>Harvest crops </td><td><input id="cropsH" type="text" value="0" size="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item:&nbsp;<select id="cropsHIN">'.$this->GetOptionsByTypeName("plot_contract").'</select>Reputation & Goods</td></tr>
                          <tr><td>Water crops  </td><td><input id="cropsW" type="text" value="0" size="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item:&nbsp;<select id="cropsWIN">'.$this->GetOptionsByTypeName("plot_contract").'</select>Reputation &  Coins</td></tr>
                          <tr><td>Revive crops </td><td><input id="cropsR" type="text" value="0" size="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item:&nbsp;<select id="cropsRIN">'.$this->GetOptionsByTypeName("plot_contract").'</select>Reputation &  Coins</td></tr>

                          <tr BGCOLOR="grey"><td><b>Visits</b></td><td></td></tr>
                          <tr><td>Residence </td><td><input id="residence" type="text" value="0" size="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item:&nbsp;<select id="residenceIN">'.$this->GetOptionsByTypeName("residence").'</select>Reputation &  Coins</td></tr>
                          <tr><td>Community Buildings <br>(Not working Yet)</td><td><input DISABLED id="municipal" type="text" value="0" size="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item:&nbsp;<select DISABLED id="municipalIN">'.$this->GetOptionsByTypeName("municipal").'</select>Reputation &  Coins</td></tr>

                          <tr BGCOLOR="grey"><td COLSPAN="2"><b>Visits Businesses</b></td></tr>
                          <tr><td>Send bus to Business </td><td><input id="business" type="text" value="0" size="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item:&nbsp;<select id="businessIN">'.$this->GetOptionsByTypeName("business").'</select>Reputation &  Coins</td></tr>

                          <tr BGCOLOR="grey"><td COLSPAN="2"><b>Clear wilderness.</b> </td></tr>
                          <tr><td>Chop trees</td><td><input id="trees" type="text" value="0" size="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item:&nbsp;<select id="treesIN">'.$this->GetOptionsByTypeName("wilderness").'</select>Reputation &  Coins</td></tr>
                       ...
                       <br>
                       <br><input id="pause" type="checkbox" value="0" size="4">Pause! (When this is checked we will not visit neighbors, so uncheck and save. then in the next run we will visit the selected neighbors)
                     </td>
                    </tr>
                  </table>
                </div>
...
echo '                <div class="zag" >Neighbors that have open space for your business<br><hr><br>
